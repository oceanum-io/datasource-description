...
# Oceanum West Africa Wave Hindcast Specification
...
| Field | Value |
|---|---|
| **Title** | Oceanum West Africa wave hindcast |
...
Integrated wave parameters are stored hourly over the domain at the native model resolution. Table 2 describes long names and units of all 37 gridded output parameters.
